...
class CommunitySummary(BaseModel):
    ...
    cisv_dim1: float | None = None
    cisv_dim2: float | None = None
    cisv_dim3: float | None = None
    cisv_dim4: float | None = None
    cisv_quintile: int | None = None
    cisr_score: float | None = None
    cisr_quintile: int | None = None
